#!/usr/bin/env python3
"""
Complete Export Functionality Test
...
def test_qa_export():
    ...
    try:
        ...
        if text_export and len(text_export) > 100:
            ...
            # Save to file
            with open("test_qa_session.txt", "w", encoding="utf-8") as f:
                f.write(text_export)
            print("💾 Saved as: test_qa_session.txt")
        else:
        ...
        if pdf_buffer:
            ...
            # Save to file
            with open("test_qa_session.pdf", "wb") as f:
                f.write(pdf_buffer.getvalue())
            print("💾 Saved as: test_qa_session.pdf")
        else:
...
def test_quiz_export():
    ...
    try:
        ...
        quiz_session.user_answers = [0, 3, 2]  # All correct
        quiz_session.completed = True
        quiz_session.completion_time = datetime.now()
        
        print("📊 Testing quiz data preparation...")
        
        # Test with answers
        quiz_data_with_answers = prepare_quiz_export_data(quiz_session.__dict__, include_answers=True)
        ...
        quiz_data_no_answers = prepare_quiz_export_data(quiz_session.__dict__, include_answers=False)
...
def main():
    ...
    print("🚀 StudyMate Export Functionality Test Suite")
    print("=" * 60)
    ...
    if qa_success and quiz_success:
        ...
        print("📝 test_qa_session.txt")
        print("📑 test_qa_session.pdf")
